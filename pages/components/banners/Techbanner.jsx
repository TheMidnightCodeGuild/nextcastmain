...
export default function Webbanner() {
  return (
    <div className="min-h-[15rem] md:h-[25rem] pt-44 md:pt-52 w-full bg-black flex flex-col items-center justify-center overflow-hidden  px-4">
      <h1 className="text-3xl md:text-7xl lg:text-[4.2rem] uppercase font-semibold text-center text-white relative z-20">
